...
#
# origins = [
#     #TODO Na real isso aqui é inútil por enquanto, quando for pra setar o server
#     # vamos ter q especificar!!
#     "http://localhost:3000",
...
#         raise HTTPException(status_code=500, detail=str(e))
#
# @app.post("/set_conn_holding_time")
...
#         raise HTTPException(status_code=500, detail=str(e))
#
# @app.post("/set_confidence_interval")
...
#         raise HTTPException(status_code=500, detail=str(e))
#
# @app.post("/set_pcc_time_threshold")
